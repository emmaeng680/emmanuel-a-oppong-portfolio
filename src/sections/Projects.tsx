  ...
  return (
      <section className='pb-16 lg:py-24'>
        <div className='container'>
          ...
          <p className='text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto'>Welcome to my world where I transform concepts into engaging digital experiences.</p>
