...
import mapImage from "@/assets/images/map5.png"
        ...
        <SectionHeader title="A Glimpse Into My World" eyebrow="About Me" description="Learn more about who I am, what I do, and what inspires me." />
          <div className="mt-20 flex flex-col gap-8">
              ...
              <Card className="h-[320px] md:col-span-2 lg:col-span-1">
                  ...
                  <div className="w-40 mx-auto mt-2 md:mt-0 transform hover:-translate-y-5 hover:translate-x-2  transition duration-300 ease-out">
              ...
              <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
                <Image src={mapImage} alt="map" className="w-full h-full object-cover object-left-top" />
                  <div
                      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-10 rounded-full  after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
